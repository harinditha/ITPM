...
INSERT INTO `tbl_category` VALUES (1,'Faculty Of Computing','',NULL);
INSERT INTO `tbl_category` VALUES (2,'Faculty Of Engineering','',NULL);
INSERT INTO `tbl_category` VALUES (3,'Faculty Of Business','',NULL);
INSERT INTO `tbl_category` VALUES (4,'Faculty Of Human Resources','',NULL);
INSERT INTO `tbl_category` VALUES (5,'Faculty Of Quantity Surveying','',NULL);
...
INSERT INTO `tbl_topic` VALUES (1,'PAF Lab Practices','<p style="text-align: center;"><img src="C:UsersKawindaDesktop
dm lab32.JPG" alt="" /><br /><strong>Special Notice</strong></p>
<p id="yui_3_17_2_1_1558678982837_60">Practical 09 will be uploaded soon, and it is home work for you.</p>
<p>Note that the practical 09 should be completed by your self, before coming to the next class.</p>
<p style="text-align: left;">&nbsp;</p>','2015-05-16 10:10:49',1);
